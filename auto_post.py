...
def _generate_post_text(mode: str = "long") -> str:
    try:
        ...
        if mode == "short":
            return (
                "SynteraGPT — ваш AI-помощник на базе GPT-5. "
                "Отвечает мгновенно, умеет анализировать фото и документы.\n\n"
                "👉 Попробуй: https://t.me/SynteraGPT_bot"
            )
        return (
            "SynteraGPT — умный AI-бот на базе GPT-5. "
            "Анализ фото и документов, генерация кода, исследования, быстрые ответы. "
            "Поддерживает доступ к интернету, Википедии и историческим данным. "
            "Всегда в курсе новостей искусственного интеллекта.\n\n"
            "👉 Попробуй сейчас: https://t.me/SynteraGPT_bot"
        )
