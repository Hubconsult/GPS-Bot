...
def who_are_you(m):
    text = (
 codex/add-special-handler-in-bot.py-t0o2w1
        "Я работаю на базе GPT-5, новейшей модели. "
        "GPT-5 обеспечивает более глубокую проработку диалога, высокую точность и адаптивность, "
        "опирается на академические знания и современные исследования. "
        "Модель способна поддерживать разные стили общения: Короткий друг, Философ и Коуч. "
        "Она разработана для того, чтобы вести живой разговор, давать содержательные ответы "
        "и предлагать практические рекомендации на основе психологической науки. "
